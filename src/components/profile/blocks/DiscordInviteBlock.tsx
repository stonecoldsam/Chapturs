...
interface DiscordInviteBlockData {
...
interface DiscordInviteBlockProps {
  data: DiscordInviteBlockData
  width?: number
  height?: number
  isOwner?: boolean
  onDelete?: () => void
...
/**
 * DiscordInviteBlock - v0.1
 * Discord server invite widget
 * Shows server info and join button
 * Size: 1x1 (compact card), no expansion needed
 */
export default function DiscordInviteBlock({
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col bg-[#5865F2] text-white relative overflow-hidden">
        {/* Discord brand gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#5865F2] to-[#4752C4] opacity-90" />
        ...
        <div className="relative z-10 flex-1 p-4 flex flex-col">
          ...
          <a
            ...
            className="mt-auto w-full bg-white text-[#5865F2] font-semibold py-2 px-4 rounded-md text-sm hover:bg-gray-100 transition-colors text-center"
          >
            Join Server
          </a>
        </div>
